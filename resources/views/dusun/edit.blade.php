                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative mb-3">
                                                ...
                                                <select class="select2 form-control" name="id_desa" id="id_desa">
                                                    ...
                                                    @foreach ($desa as $ds)
                                                        <option value="{{ $ds->id }}"
                                                            {{ isset($hamlet) && $hamlet->village->id == $ds->id ? 'selected' : '' }}>
                                                            {{ $ds->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text" name="dusun" id="dusun"
                                                    value="{{ $hamlet->dusun }}" class="form-control">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text" name="alamat" id="alamat"
                                                    value="{{ $hamlet->alamat }}" class="form-control">
                                                <small class="text-danger"
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text" name="hp" id="hp"
                                                    value="{{ $hamlet->hp }}" class="form-control">
