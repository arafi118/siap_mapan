...
<head>
    ...
    <title>Struk Retribusi Sampah</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        @foreach ($usage as $use)
            <div class="box">
                <table border="0" width="100%">
                    <tr>
                        ...
                        <td width="30%" align="center">
                            ...
                            <div style="font-size: 12px; font-weight: bold;">RETRIBUSI SAMPAH</div>
                        </td>
                ...
                <table class="tb-padding-sm" border="0" width="100%" style="font-size: 11px;">
                    ...
                    <tr>
                        <td width="15%" align="left" style="padding-left: 24px;">&nbsp;</td>
                    ...
                    <tr>
                        <td width="15%" align="left" style="padding-left: 24px;">Tagihan</td>
                        <td width="2%" align="right">:</td>
                    ...
                    <tr>
                        ...
                        <td width="35%" class="keterangan terbilang">
                            <i>{{ ucwords($keuangan->terbilang($use->installation->abodemen)) }}
                                Rupiah</i>
                        </td>
                        <td width="2%" align="center">&nbsp;</td>
                    </tr>
                    <tr>
                        <td width="15%" align="left" style="padding-left: 24px;">&nbsp;</td>
                        <td width="2%" align="right">&nbsp;</td>
                        <td width="35%" class="keterangan terbilang">&nbsp;</td>
                        <td width="2%" align="center">&nbsp;</td>
