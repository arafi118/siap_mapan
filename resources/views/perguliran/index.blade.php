        ...
        <div class="card mb-4">
            <div class="card-body">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" data-target="#Permohonan" href="#"><b>Permohonan(P)</b></a>
                    </li>
                    <li class="nav-item">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="" class="btn btn-primary"><i class="fa fa-exclamation-circle"></i></a>
