...
@section('content')
    <!-- Form -->
    <form action="/installations/{{ $installation->id }}" method="post" id="status_S">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="alert alert-success d-flex align-items-center" role="alert">
                            ...
                            <!-- Konten Teks -->
                            <div>
                                <h4 class="alert-heading"><b>Customer an.111 {{ $installation->customer->nama }}</b></h4>
                                <hr>
                                <p class="mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 50%; font-size: 14px; padding: 8px;">
                                            paket
                                            <span class="badge badge-danger"
                                                style="width: 20%; padding: 5px;">{{ $installation->package ? $installation->package->kelas : '' }}</span>
                                        </td>
                                        <td style="width: 50%; font-size: 14px; padding: 8px;">
                                            Tarif meteran
                                            <span class="badge badge-danger"
