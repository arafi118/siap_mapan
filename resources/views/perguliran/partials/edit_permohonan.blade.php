                ...
                <form action="/installations" method="post" id="FormRegisterPermohonan">
                    ...
                    <div class="row">
                        <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative mb-3">
                                            ...
                                            <input type="text" class="form-control date" name="order" id="order"
                                                ...
                                                value="{{ \Carbon\Carbon::parse($installations->order)->format('d/m/Y') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative mb-3">
                                            ...
                                            <input type="text" class="form-control total" aria-describedby="total"
                                                name="total" id="total"
                                                value="{{ number_format($installations->package->abodemen - $trx, 2) }}">
                            ...
                            <button type="submit" id="SimpanPermohonan" class="btn btn-dark btn-icon-split"
